...
export default function Home() {
  return (
    <>
      <section className="min-h-screen bg-[#f7dc6f]">
        ...
        <div className="flex flex-col lg:flex-row p-4 sm:p-6 lg:p-8 gap-6 lg:gap-8 items-center lg:items-center mb-14">
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-14 w-full lg:w-1/2">
            <h1 className="text-4xl sm:text-6xl lg:text-8xl font-bold text-[#263d4d] leading-tight">Train. Teach.<br /> Earn Globally</h1>
            <p className="text-lg sm:text-2xl lg:text-3xl text-[#263d4d] max-w-full lg:max-w-[80%] leading-relaxed">
        ...
        <div className="flex justify-center items-center pb-8 lg:pb-12">
          <div className="text-center">
            <p className="text-lg sm:text-xl lg:text-3xl text-[#263d4d] font-light tracking-wide italic">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#F8F5ED] px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#f7dc6f] mb-4">What We Do</h2>
            <div className="w-20 h-1 bg-[#f7dc6f] mx-auto"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-[#f7dc6f]/20 rounded-full flex items-center justify-center mb-6 hover:bg-[#f7dc6f]/30 transition-colors">
                <svg className="w-10 h-10 sm:w-12 sm:h-12 text-[#f7dc6f]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z" />
                </svg>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-[#f7dc6f] mb-3">Teacher Training</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#f7dc6f] mb-3">Professional Certification</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#f7dc6f] mb-3">Teacher Recruitment</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#f7dc6f] mb-3">Ongoing Support</h3>
      ...
      {/* Trusted By Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-linear-to-r from-[#1b5276] to-[#153f5e] px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#F8F5ED] px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#f7dc6f] mb-4">What Our Teachers Say</h2>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#F8F5ED] px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#f7dc6f] mb-4">Our Training Programs</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-10 px-4">
            {/* Course Card 1 */}
            <div className="bg-linear-to-br from-[#F8F5ED] to-[#F8F5ED] border-2 border-[#f7dc6f]/30 rounded-lg p-6 sm:p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="w-12 h-12 bg-[#1b5276] rounded-lg flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-[#f7dc6f] mb-3">Our Training Programs</h3>
            ...
            <div className="bg-linear-to-br from-[#F8F5ED] to-[#F8F5ED] border-2 border-[#f7dc6f]/30 rounded-lg p-6 sm:p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-[#f7dc6f] mb-3">ESL Teaching Practicum</h3>
            ...
            <div className="bg-linear-to-br from-[#F8F5ED] to-[#F8F5ED] border-2 border-[#f7dc6f]/30 rounded-lg p-6 sm:p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-2xl font-bold text-[#f7dc6f] mb-3">Upskill Teachers Program</h3>
          ...
          <div className="flex justify-center">
            <a
              href="/courses"
              className="inline-block bg-[#1b5276] hover:bg-[#153f5e] text-white font-bold py-3 px-8 sm:py-4 sm:px-10 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              View All Courses →
            </a>
          </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-linear-to-r from-[#1b5276] to-[#153f5e] px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="/courses"
            className="inline-block bg-white hover:bg-[#F8F5ED] text-[#f7dc6f] font-bold py-4 px-10 sm:py-5 sm:px-12 rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 text-lg"
          >
            Explore Courses Now
          </a>
        </div>
