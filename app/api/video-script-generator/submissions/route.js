...
export async function POST(request) {
  try {
    ...
    const res = await fetch(`${API_URL}/video-script-generator/submissions`, {
      method: "POST",
      headers: {
    ...
    if (!res.ok) {
      ...
      console.error("Failed to submit video script generator:", errorData);
      return NextResponse.json(
    ...
    console.error("Error submitting video script generator:", err);
    return NextResponse.json(
