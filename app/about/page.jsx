...
export default function About() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="pt-24 sm:pt-32 lg:pt-40 pb-12 sm:pb-16 lg:pb-20 bg-linear-to-b from-amber-50 to-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center fade-in">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-amber-800 mb-6">About Prouda Tutors</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="slide-in-left">
              <div className="relative w-full aspect-square rounded-xl overflow-hidden shadow-2xl">
                <Image
                  src="https://media.istockphoto.com/id/2174878381/photo/female-teacher-with-group-of-students.jpg?s=2048x2048&w=is&k=20&c=fFjgqj4zVu-umjO2gtdvHSlesS9kbYw-6rH3xuKVf1A="
            ...
            <div className="slide-in-right px-4">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-amber-800 mb-6">Who We Are</h2>
              <div className="space-y-4 text-gray-700">
                <p className="text-lg leading-relaxed">
                  We support teachers through <span className="font-semibold text-amber-700">structured training</span>, professional certification, and access to international teaching roles.
                </p>
                <p className="text-lg leading-relaxed">
              ...
              <div className="mt-8 space-y-4">
                <div className="flex gap-4 items-start scale-in">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-amber-800 mb-1">Comprehensive Training</h3>
                ...
                <div className="flex gap-4 items-start scale-in" style={{ animationDelay: '0.1s' }}>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-amber-800 mb-1">Professional Certification</h3>
                ...
                <div className="flex gap-4 items-start scale-in" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-amber-800 mb-1">Global Placement Support</h3>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-linear-to-r from-amber-50 to-amber-100 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 px-4">
            ...
            <div className="fade-in bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-amber-800">Our Mission</h3>
              </div>
              <p className="text-lg text-gray-700 leading-relaxed">
                To equip teachers with the skills, confidence, and opportunities to <span className="font-semibold text-amber-700">teach globally</span>.
              </p>
            </div>
            ...
            <div className="fade-in bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: '0.1s' }}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-amber-800">Our Vision</h3>
              </div>
              <p className="text-lg text-gray-700 leading-relaxed">
                To become a leading bridge between trained <span className="font-semibold text-amber-700">African teachers</span> and global education institutions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-amber-800 mb-4 fade-in">Our Growth Journey</h2>
            <p className="text-lg sm:text-xl text-gray-600 fade-in">Celebrating milestones and expanding our impact across continents</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 px-4">
            {/* Stats Card 1 */}
            <div className="bg-linear-to-br from-amber-50 to-white border-2 border-amber-200 rounded-lg p-8 sm:p-10 text-center hover:shadow-xl transition-all duration-300 scale-in">
              <div className="mb-6">
                <svg className="w-16 h-16 sm:w-20 sm:h-20 text-amber-500 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z" />
                </svg>
              </div>
              <h3 className="text-4xl sm:text-5xl font-bold text-amber-700 mb-3">100+</h3>
              <p className="text-xl text-gray-700 font-semibold">Teachers Successfully Placed in Schools Worldwide</p>
            </div>

            {/* Stats Card 2 */}
            <div className="bg-linear-to-br from-amber-50 to-white border-2 border-amber-200 rounded-lg p-8 sm:p-10 text-center hover:shadow-xl transition-all duration-300 scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="mb-6">
                <svg className="w-16 h-16 sm:w-20 sm:h-20 text-amber-500 mx-auto" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-4xl sm:text-5xl font-bold text-amber-700 mb-3">20+</h3>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-linear-to-r from-amber-600 to-amber-700 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-amber-50 mb-10 leading-relaxed fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 fade-in">
            <a
              href="/courses"
              className="inline-block bg-white hover:bg-amber-50 text-amber-700 font-bold py-3 px-8 sm:py-4 sm:px-10 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Start Training →
            </a>
            <a
              href="/contact"
              className="inline-block bg-amber-500 hover:bg-amber-400 text-white font-bold py-3 px-8 sm:py-4 sm:px-10 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Get in Touch
            </a>
          </div>
